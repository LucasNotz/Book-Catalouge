...
public class EditBook extends JFrame{
	...
	public EditBook(DefaultListModel<String> booksDLM, JList<String> booksList, String bookTitle) {
		setTitle("Edit Book");
		setSize(400, 520);
		...
		editBook.setBounds(140,430, 100, 30);
		add(editBook);
	
		List<String> bookInfo = BooksDAO.searchBook(bookTitle);
		isbnField.setText(bookInfo.get(0));
		titleField.setText(bookInfo.get(1));
		descriptionArea.setText(bookInfo.get(2));
		timesReadField.setText(bookInfo.get(3));
		timesReadDescriptionArea.setText(bookInfo.get(4));
		...
		editBook.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				BooksDAO.editBook(isbnField.getText(), titleField.getText(), descriptionArea.getText(), timesReadField.getText(), timesReadDescriptionArea.getText());
